<div id="main-nav-container" class="top-nav-container">
    <button class="nav-item" data-view="avatarEditor">Avatar Editor</button>
    <button class="nav-item" data-view="mapEditor">Map Editor</button>
    <button class="nav-item" data-view="gameEditor">Game Editor</button>
</div>
